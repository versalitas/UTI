...
class chatProjector extends React.Component {
  ...
  renderLogo() {
    if(!this.state.isLastScene) {
      return <img className="utiUsers" src={utiUsers} alt="users' icon"></img>;
    } else {
      return null;
    }
  }
        ...
        return (
            ...
            <div className="showContainer">
                   ...
                   <aside className="chatSide">
                     ...
                     {sceneDescription}</div>
                     </div>
                     <div id="userContainer">
                      <div id="userIcon"><div>{this.renderLogo()}</div>
                     <div className="chatUsers"><Users socket={socket} users={userList} type='projector'  /></div></div>
                     </div>
                    </aside>
